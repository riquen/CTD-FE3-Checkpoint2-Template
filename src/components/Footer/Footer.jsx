  ...
  return (
    <footer>
      <div className={styles.footerWrapper}>
        ...
        <div className={`${theme === 'dark' ? 'navbar-dark bg-dark' : 'navbar-light bg-light'} ${styles.footer}`}>
          <div className="container">
            <div className={`row`}>
              <div className="col-sm-12 col-lg-6">
                {/* //Na linha seguinte deverá ser feito um teste se a aplicação
                // está em dark mode e deverá utilizar o css correto */}
                <img className={`${theme === 'dark' && styles.iconsDark} ${styles.dhLogo}`} src="/images/DH.png" alt='DH-logo' />
              </div>
